...
def getPlayMove(board):
    moveDict = {'z': '1', 'x': '2', 'c': '3', 'a': '4', 's': '5', 'd': '6', 'q': '7', 'w': '8', 'e': '9'}
    moves = ''
...
while True:
    ...
    while gameIsPlaying:
        if turn == 'player':
            drawBoard(theBoard)
            moves = getPlayMove(theBoard)
            makeMove(theBoard, playerLetter, moves)
            ...
            moves = getComputerMove(theBoard, computerLetter)
