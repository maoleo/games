...
words = 'ant baboon badger bat bear beaver camel cat clam cobra cougar coyote crow deer dog donkey duck eagle ferret' \
        ...
        ' trout turkey turtle weasel whale wolf wombat zebra red orange yellow green blue indigo violet white black ' \
        'brown square triangle rectangle circle ellipse rhombus trapazoid chevron pentagon hexagon septagon octogon' \
